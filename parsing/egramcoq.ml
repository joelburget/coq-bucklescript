...
let symbol_of_target : type s. _ -> _ -> _ -> s target -> (s, s) symbol = fun p assoc from forpat -> failwith "undefined: symbol_of_target"
(*
...
let symbol_of_entry : type s r. _ -> _ -> (s, r) entry -> (s, r) symbol = fun assoc from typ -> failwith "undefined: symbol_of_entry"
(*
match typ with
